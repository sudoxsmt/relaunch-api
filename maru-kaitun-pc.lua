...
repeat task.wait() until game.Players.LocalPlayer:FindFirstChild("PlayerGui")
    ...
    _G.Fruits_Settings = { -- ตั้งค่าผล
        ...
        ['Select_Fruits'] = {"Flame-Flame", "Ice-Ice", "Quake-Quake", "Light-Light", "Dark-Dark", "Spider-Spider", "Rumble-Rumble", "Magma-Magma"} -- กินหรือซื้อตอนไม่มีผล
    }
